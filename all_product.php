...
?>
<!DOCTYPE html>
<html lang="en" data-page="all-products">
<head>
    <meta charset="UTF-8">
...
<body data-page="all-products" data-api-base="actions/product_actions.php">
<div class="app-shell">
    ...
    <div class="container-xxl">
        <div class="app-card mb-4">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
                <div>
                    <span class="badge-gradient">Discover</span>
                    <h2 class="mt-3 mb-1">All Products</h2>
                    <p class="text-muted mb-0">Browse our complete catalogue. Filter by category or brand, or jump into a detailed view.</p>
                </div>
                ...
                <form class="row g-3" data-role="inline-search-form">
                    <div class="col-lg-6">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Search by product name or keyword" data-role="product-search-input">
                        </div>
                    </div>
                    <div class="col-lg-3">
